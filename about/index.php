...
Это подтверждено множеством наших наград и сертификатов, представленных ниже.</p>
            ...
            <div class="infoBlocksContent about_tabs" id="exclusiveBrands">
	            <p><img border="0" src="http://dev.amatagroup.ru/upload/medialibrary/5f6/excluz-amata.png">
Мы являемся эксклюзивным дистрибьютором по ряду брендов в РФ, а также на территории Таможенного союза ЕАЭС. На данные бренды мы предоставляем максимально выгодные ценовые предложения и маркетинговую поддержку, что позволит Вам зарабатывать больше.</p>
	            <h3>БРЕНДЫ</h3>
	            <?
	...
	false
	        ...
	        <p>Мы являемся официальным дистрибьютором по ряду брендов, имеющих высокую моржинальность. Эти бренды позволят Вам полностью обеспечить магазин всей необходимой продукцией.</p>
	        <h3> </h3>
            <?
