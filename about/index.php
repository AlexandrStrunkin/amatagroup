...
?>
        <div class="widthWrapper">
            ...
            <div class="infoBlocksContent about_tabs" id="exclusiveBrands">
	            <p>Мы являемся эксклюзивным дистрибьютором по ряду брендов в РФ, а также на территории Таможенного союза ЕАЭС. На данные бренды мы предоставляем максимально выгодные ценовые предложения и маркетинговую поддержку, что позволит Вам зарабатывать больше.</p>
	            <h3>БРЕНДЫ</h3>
	            <?
