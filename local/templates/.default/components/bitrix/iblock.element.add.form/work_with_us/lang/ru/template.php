...
$MESS['TEXT_AREA_PLACEHOLDER'] = 'Текст сообщения*';
$MESS['RESUME_FILE'] = 'Загрузите файл резюме';     
$MESS['SEND_RESUME'] = 'Отправить резюме';         
$MESS['FORM_SUCCESS'] = 'Ваше резюме отправлено, мы обязательно с вами свяжемся, после обработки заявки.';  
$MESS['TEXT_AREA_PLACEHOLDER'] = 'Введите сообщение'; 
$MESS['EMPTY_FIELDS'] = 'Все поля обязательны для заполнения!';                
?>