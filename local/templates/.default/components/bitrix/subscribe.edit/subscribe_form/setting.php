...
<tr valign="top">
	<td width="50%">
		<p><?echo GetMessage("subscr_email")?><span class="starrequired">*</span><br /><br/>
		...
		<?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
			<label><input type="checkbox" name="RUB_ID[]" value="<?=$itemValue["ID"]?>"<?if($itemValue["CHECKED"]) echo " checked"?> /><?=$itemValue["NAME"]?></label><br /><br/>
		<?endforeach;?></p>
