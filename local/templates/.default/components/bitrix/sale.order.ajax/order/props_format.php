		...
		if (!empty($arSource))
		{
			?>	<?
				...
				?>
					...
					<? if (($current_props_group == 3 && ($iteration_counter == 1 || $iteration_counter == 2)) || ($current_props_group == 4 && ($iteration_counter == 6 || $iteration_counter == 9))) { // çàêðûâàåì col?>
						</div>	
					<? } ?>
					<? if (($current_props_group == 3 && ($iteration_counter == 2 || $iteration_counter == 4)) || ($current_props_group == 4 && $iteration_counter == 9)) { // çàêðûâàåì row?>
						</div>	
					<? } ?>
					<? $iteration_counter++; ?>
						<?
