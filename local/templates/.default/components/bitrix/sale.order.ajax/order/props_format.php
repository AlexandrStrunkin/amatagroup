		...
		if (!empty($arSource))
		{
			?>	<?
				...
				?>
					...
					{	
						$current_props_group = $arProperties["PROPS_GROUP_ID"];
						?>
						<? if ($current_props_group == 3 && ($iteration_counter == 0 || $iteration_counter == 3)) { // äàííûå ïëàòåëüùèêà ?>
							<div class="<?= $iteration_counter == 0 ? "row1" : "row2" ?>">
						<? } ?>
					...
					<? if (($current_props_group == 3 && ($iteration_counter == 1 || $iteration_counter == 2)) || ($current_props_group == 4 && ($iteration_counter == 6 || $iteration_counter == 9)) || $last_property == $arProperties) { // çàêðûâàåì col?>
						</div>	
					<? } ?>
					<? if (($current_props_group == 3 && ($iteration_counter == 2 || $iteration_counter == 4)) || ($current_props_group == 4 && $iteration_counter == 9) || $last_property == $arProperties) { // çàêðûâàåì row?>
						</div>	
					<? } ?>
					<? $iteration_counter++; ?>
						<?
