...
<a href="" name="order_form"></a>

<div class="dataPayer order-checkout">
			...
			<?if($_POST["is_ajax_post"] != "Y")
			{
				?>	</div>
					...
					<div class="row7">
                        <!--col1-->
                        <div class="col1">
                            <p><?= GetMessage("SOA_TEMPL_CHECK_ALL_AND_CONFIRM") ?></p>
                        </div>
                        <!--END col1-->
                        <!--col2-->
                        <div class="col2">
                            <button type="submit" onclick="submitForm('Y'); return false;" id="ORDER_CONFIRM_BUTTON" class="checkout"><?= GetMessage("SOA_TEMPL_ALL_RIGHT_CONFIRM") ?></button>
                        </div>
                        <!--END col2-->
                    </div>
				</form>
