...
$MESS['SOA_TEMPL_DELIVERY'] = "Доставка заказа";
...
$MESS['SOA_TEMPL_BUYER_INFO'] = "Данные плательщика";
...
$MESS['SOA_TEMPL_DELIVERY_BLOCK_TITLE'] = "Новый адрес доставки";
$MESS['SOA_TEMPL_SUMMARY_BLOCK_TITLE'] = "Оплата заказа";
$MESS['SOA_TEMPL_CHECK_ALL_AND_CONFIRM'] = "Проверьте правильность заполненных данных и подтвердите заказ.";
$MESS['SOA_TEMPL_ALL_RIGHT_CONFIRM'] = "Все верно, подтвердить заказ";
...
$MESS['MIN_LENGHT_MESSAGE'] = "Минимальная длина поля %s %d символов и может содержать только цифры";
?>