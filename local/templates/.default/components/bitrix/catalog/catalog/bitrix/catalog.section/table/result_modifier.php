<?
    ...
    if (!empty($arResult['ITEMS']))
    {
        ...
        $strEmptyPreview = $this->GetFolder().'/images/nophoto.png';
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            //если товар в корзине, убираем у него ссылку на добавление в корзину
            if (is_array($arResult["USER_BASKET"][$arItem["ID"]])) {
                $arItem["IN_BASKET"] = "Y";
                $arItem["ADD_URL"] = $arParams["BASKET_URL"];
            }
