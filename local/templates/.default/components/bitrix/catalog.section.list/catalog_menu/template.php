...
<?if (0 < $arResult["SECTIONS_COUNT"]) {?>
    <ul class="js-catalog-menu">
        <?
            ...
            ?>
            <li <? if ($arSection["DEPTH_LEVEL"] == 2) { ?> class="firstLvlLi" <? } elseif($arSection["DEPTH_LEVEL"] == 1) { ?> class="topLvlLi" <? } ?> id="<?=$this->GetEditAreaId($arSection['ID']);?>" data-id="<?=$arSection['ID']?>" data-depth-lvl="<?=$arSection["DEPTH_LEVEL"]?>">
