<?
    ...
    foreach ($arResult['ITEMS'] as $key => $arItem) {
        ...
        if (!empty($arItem["PROPERTIES"]["SALE_PRODUCT"]["VALUE"])) {
            $dbProductDiscounts = CCatalogDiscount::GetList(array("SORT" => "ASC"), array("PRODUCT_ID" => $arItem["PROPERTIES"]["SALE_PRODUCT"]["VALUE"], "ACTIVE" => "Y",), false, false, array('VALUE','VALUE_TYPE','PRODUCT_ID'))->Fetch();
