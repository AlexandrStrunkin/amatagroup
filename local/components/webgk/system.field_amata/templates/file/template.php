...
foreach ($arResult["VALUE"] as $res):
	...
	<div class="fields files">
		...
		<?=CFile::InputFile($arParams["arUserField"]["FIELD_NAME"], 0, $res, false, 0, "", "id='name_" . $arParams["arUserField"]["ID"] . "'", 0, "", ' value="'.$res.'"', true, isset($arParams['SHOW_FILE_PATH']) ? $arParams['SHOW_FILE_PATH'] : true);?>
		<br>
<?
